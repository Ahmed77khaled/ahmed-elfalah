# Migrating web UI to Fel7o Design System

Read `artifacts/fel7o-ds/docs/AGENTS.md` and
`artifacts/fel7o-ds/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/fel7o-ds/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/fel7o-ds/lib/utils`
- `@/hooks/use-toast` → `@workspace/fel7o-ds/hooks/use-toast`
