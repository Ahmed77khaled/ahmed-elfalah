# Fel7o Design System design system
...
workspace package (`@workspace/fel7o-ds`): other artifacts depend
...
`@workspace/fel7o-ds/components/...`. Never use a `@/` alias inside
...
for `@workspace/fel7o-ds` and renders mockups using this package's
theme and components.

## Consuming this package

Never copy token values, component source, hooks, or these docs into a consuming
artifact. Add `@workspace/fel7o-ds` as a `workspace:*` dependency,
run `pnpm install`, and import directly from this package.

Read only the guides required by the current task:

- Building or styling web UI: `artifacts/fel7o-ds/docs/consuming-web.md`
- Building or styling Expo UI: `artifacts/fel7o-ds/docs/consuming-expo.md`
- Replacing an existing or scaffolded web theme/component library:
  `artifacts/fel7o-ds/docs/migrating-web.md`
- Replacing existing or scaffolded Expo theme/hooks/components:
  `artifacts/fel7o-ds/docs/migrating-expo.md`
