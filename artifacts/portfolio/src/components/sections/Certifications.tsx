...
type Certification = { title: string; issuer: string; detail: string; credential: string; verifyUrl?: string; evidenceUrl?: string };
const certifications: Certification[] = [
  { title: "CCNA Routing and Switching", issuer: "CCNA Training Program", detail: "98% Score · 120 hrs", credential: "Networking & Security", evidenceUrl: "/labs/ccna/ccna-routing-switching-certificate.pdf" },
