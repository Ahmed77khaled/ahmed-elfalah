# Consuming Fel7o Design System in Expo apps

Read `artifacts/fel7o-ds/docs/AGENTS.md` first. React Native does
...
`artifacts/fel7o-ds/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/fel7o-ds/tokens";
...
```tsx
import { nativeTheme } from "@workspace/fel7o-ds/lib/native-theme";
import { useColors } from "@workspace/fel7o-ds/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/fel7o-ds/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/fel7o-ds/components/native/badge";
import { Button } from "@workspace/fel7o-ds/components/native/button";
import { Card } from "@workspace/fel7o-ds/components/native/card";
```
...
Import and render
`@workspace/fel7o-ds/components/native/button`, then run Expo
