# Consuming Fel7o Design System in web apps

Read `artifacts/fel7o-ds/docs/AGENTS.md` first. This guide covers
...
`artifacts/fel7o-ds/docs/migrating-web.md` before writing UI.
...
`node_modules/@workspace/fel7o-ds/src/components` to `content`.
...
import {
  toast,
  useToast,
} from "@workspace/fel7o-ds/hooks/use-toast";
```
...
`@workspace/fel7o-ds/components/ui/button`. Run the app's typecheck
