# Migrating Expo UI to Fel7o Design System

Read `artifacts/fel7o-ds/docs/AGENTS.md` and
`artifacts/fel7o-ds/docs/consuming-expo.md` first. Use this guide
...
- Rewrite color/theme imports to
  `@workspace/fel7o-ds/lib/native-theme` and
  `@workspace/fel7o-ds/hooks/use-colors`.
- Rewrite the root layout to use
  `@workspace/fel7o-ds/hooks/use-fonts` while preserving its
  SplashScreen gating.
...
and hook directly from `@workspace/fel7o-ds` and retains only
